...
public class UpbringingInformation : MonoBehaviour
{
    ...
    private string[] Chat = { "마지막으로 이것만 알려드리고 설명을 마치도록 하겠습니다.","여기 도감이 보이시죠? 한 번 열어보시겠어요?"
            ,"여기서 지금까지 확인한 음식과 강아지의 정보를 확인할 수 있습니다.","어떻게 기록되는지에 대해선 저희에게 알려진 바는 없지만...뭐, 이 세계 자체가 특별하니까요. 의외로 흔한 일 일수도 있죠.",
