...
public class Book : MonoBehaviour
{
    ...
    private ending_controller endingcontrol;
    [SerializeField]
    ...
    void Start()
    {
        endingcontrol = FindObjectOfType<ending_controller>();
    ...
    void UpdateSprites()
    {
        ...
        else if (endingcontrol.clickCount == 4)
        {
            if (currentPage == 2)
            {
                NextButton.gameObject.SetActive(true);
